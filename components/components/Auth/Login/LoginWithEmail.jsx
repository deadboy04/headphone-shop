...
export default function LoginUpWithEmail() {
                        ...
                        >
                            ...
                            <Grid item className={classes.heading}>
                                <div className={classes.passwordSection}>
                                    <Link className={classes.forgotPassword} href='#'>Forgot password?</Link>
                                    <Typography variant='h2'>
                            ...
                            <Grid item>
                                <div className={classes.logInSection}>
                                    <Link color="inherit" href='#' underline='none'> <Facebook fontSize='large'
                                                                                               className={classes.logInIconFa}/>
                                    </Link>
                                    <Link color="inherit" href='#' underline='none'> <GTranslate fontSize='large'
